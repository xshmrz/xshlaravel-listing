<?php
    ...
    class IncomeExpense extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("panel.income-expense.edit", $incomeExpense->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$incomeExpense) {
                ...
                return redirect()->route("panel.income-expense.index");
            }
            $incomeExpense->fill($data);
            $incomeExpense->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("panel.income-expense.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("panel.income-expense.index")->withInput();
        }
    }
