<?php
    ...
    class Listing extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.listing.edit", $listing->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$listing) {
                ...
                return redirect()->route("site.listing.index");
            }
            $listing->fill($data);
            $listing->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.listing.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("site.listing.index")->withInput();
        }
    }
