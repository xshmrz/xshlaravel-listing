<?php
    ...
    class Worker extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.worker.edit", $worker->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$worker) {
                ...
                return redirect()->route("site.worker.index");
            }
            $worker->fill($data);
            $worker->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.worker.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("site.worker.index")->withInput();
        }
    }
