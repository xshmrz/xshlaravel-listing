<?php
    ...
    class Appointment extends Controller {
        ...
        public function store(Request $request) {
            ...
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.appointment.edit", $appointment->id);
        }
        ...
        public function update(Request $request, $id) {
            ...
            if (!$appointment) {
                ...
                return redirect()->route("site.appointment.index");
            }
            $appointment->fill($data);
            $appointment->save();
            session()->flash('success', trans("app.İşlem Başarılı"));
            return $request->has("redirect") ? redirect()->to($request->get("redirect")) : redirect()->route("site.appointment.edit", $id);
        }
        public function destroy($id) {
            ...
            return request()->has("redirect") ? redirect()->to(request()->get("redirect"))->withInput() : redirect()->route("site.appointment.index")->withInput();
        }
    }
